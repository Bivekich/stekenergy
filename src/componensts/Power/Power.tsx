      ...
      <div className="flex bg-[#06375c] w-1/2 h-full opacity-80 flex-col text-white">
        <div className="relative flex w-full h-44 justify-end items-center group">
          ...
          <div className="flex w-6/12">
            ...
            <div className="flex w-4/5 flex-col gap-y-2 ml-5">
              <span className="text-2xl">Профессиональная команда</span>
              <span className="w-11/12 text-[13px]">
        ...
        <div className="relative flex w-full h-44 justify-end items-center group">
          ...
          <div className="flex w-6/12">
            ...
            <div className="flex w-4/5 flex-col gap-y-2 ml-5">
              <span className="text-2xl">Полная производственная цепочка</span>
              <span className="w-11/12 text-[13px]">
        ...
        <div className="relative flex w-full h-44 justify-end items-center group">
          ...
          <div className="flex w-6/12">
            ...
            <div className="w-4/5 flex flex-col gap-y-2 ml-5">
              <span className="text-2xl">Широкий спектр деятельности</span>
              <span className="w-11/12 text-[13px]">
        ...
        <div className="relative flex w-full h-44 justify-end items-center group">
          ...
          <div className="flex w-6/12">
            ...
            <div className="w-4/5 flex flex-col gap-y-2 ml-5">
              <span className="text-2xl">Экспортная торговля</span>
              <span className="w-11/12 text-[13px]">
