        ...
        <div className="flex flex-col lg:flex-row justify-center lg:space-x-20 h-full items-center">
          <div className="flex flex-col w-full lg:w-1/3 justify-center">
            ...
            <span className="mt-10 text-[#959597]">
              Компания Stekenergy, основанная в 2004 году, является
              торгово-производственным предприятием в сфере машиностроения,
              которое занимается проектированием, производством и поставкой
              дизельных генераторных установок, газовых генераторных установок,
              морских генераторов и дизельных/газовых электростанций, формируя
              целую промышленную цепочку.
            </span>
